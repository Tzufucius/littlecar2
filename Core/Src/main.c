...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LIFT_UP_LIMIT_Pin LIFT_DOWN_LIMIT_Pin SLIDE_FRONT_LIMIT_Pin SLIDE_REAR_LIMIT_Pin */
  GPIO_InitStruct.Pin = LIFT_UP_LIMIT_Pin|LIFT_DOWN_LIMIT_Pin|SLIDE_FRONT_LIMIT_Pin|SLIDE_REAR_LIMIT_Pin;
